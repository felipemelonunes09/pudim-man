...
class Sprites:
    ...
    class Pan:
        walkRight        = [pygame.transform.smoothscale(pygame.image.load(f"{globals.PAN_IMAGE_DIR}/right/{i}.png"), SPRITE_SCALE_RATIO) for i in range(0, 4)]
        walkLeft         = [pygame.transform.smoothscale(pygame.image.load(f"{globals.PAN_IMAGE_DIR}/left/{i}.png"), SPRITE_SCALE_RATIO) for i in range(0, 4)]
    class Jelly:
        walkRight        = [pygame.transform.smoothscale(pygame.image.load(f"{globals.JELLY_IMAGE_DIR}/right/{i}.png"), SPRITE_SCALE_RATIO) for i in range(0, 4)]
        walkLeft         = [pygame.transform.smoothscale(pygame.image.load(f"{globals.JELLY_IMAGE_DIR}/left/{i}.png"), SPRITE_SCALE_RATIO) for i in range(0, 4)]
